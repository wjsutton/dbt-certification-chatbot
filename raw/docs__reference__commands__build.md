...
- build [user-defined functions](https://docs.getdbt.com/docs/build/udfs) (available from dbt Core v1.11 and in the fusion_engine)
...
**Skipping on model errors:** By default, if a model fails, all downstream models are skipped. Set [`on_error: continue`](https://docs.getdbt.com/reference/resource-configs/on_error) on a model to allow its downstream models to run even when that model fails.
...
## Functions
_Available from dbt Core v1.11 and in the fusion_engine_
