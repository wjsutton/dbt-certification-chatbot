...
>
> State selection and deferral rely on your models being [idempotent](https://docs.getdbt.com/best-practices/idempotence), meaning re-running with the same inputs returns the same result. For more info, refer to [Idempotence in dbt](https://docs.getdbt.com/best-practices/idempotence).
